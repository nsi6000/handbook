...
- Use [Spaced Repetition](https://en.wikipedia.org/wiki/Spaced_repetition):
    - To fight the [Forgetting Curve](https://en.wikipedia.org/wiki/Forgetting_curve).
...
- Make your own [study guide](https://en.wikipedia.org/wiki/Study_guide) :
    - Include an outline, learning objectives, core concepts (make an [index](https://en.wikipedia.org/wiki/Index_(publishing))), personal tips and tricks about the subject, acronyms and mnemonics, interesting questions and answers, personal insights,...
